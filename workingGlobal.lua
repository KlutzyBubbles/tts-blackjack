...
function onload()
	...
	objectSets = {
        ...
        container=getObjectFromGUID("df8d40"), prestige=getObjectFromGUID("885bf4"), btnHandler=getObjectFromGUID("355712"), tbl=getObjectFromGUID("758fe9")},
		{color="Pink", zone=getObjectFromGUID("44f05e"), value=0, count=0,
        container=getObjectFromGUID("7c4eb9"), prestige=getObjectFromGUID("0b4a58"), btnHandler=getObjectFromGUID("4503f9"), tbl=getObjectFromGUID("bb54b1")},
		{color="Purple", zone=getObjectFromGUID("63ef4e"), value=0, count=0,
        container=getObjectFromGUID("54d217"), prestige=getObjectFromGUID("17ddfd"), btnHandler=getObjectFromGUID("2a52f9"), tbl=getObjectFromGUID("b2ab0b")},

		{color="Blue", zone=getObjectFromGUID("423ae1"), value=0, count=0, 
        container=getObjectFromGUID("f2e64b"), prestige=getObjectFromGUID("f87e7b"), btnHandler=getObjectFromGUID("5d5e85"), tbl=getObjectFromGUID("7a414f")},

		{color="Teal", zone=getObjectFromGUID("5c2692"), value=0, count=0, 
        container=getObjectFromGUID("54cc65"), prestige=getObjectFromGUID("3484cc"), btnHandler=getObjectFromGUID("925380"), tbl=getObjectFromGUID("d21b66")},

		{color="Green", zone=getObjectFromGUID("595fa9"), value=0, count=0,
        container=getObjectFromGUID("579f2e"), prestige=getObjectFromGUID("a7bb1b"), btnHandler=getObjectFromGUID("031d13"), tbl=getObjectFromGUID("2612ed")},

		{color="Yellow", zone=getObjectFromGUID("5b82fd"), value=0, count=0,
        container=getObjectFromGUID("486212"), prestige=getObjectFromGUID("944b87"), btnHandler=getObjectFromGUID("ab82ca"), tbl=getObjectFromGUID("a7596f")},

		{color="Orange", zone=getObjectFromGUID("38b2d7"), value=0, count=0,
        container=getObjectFromGUID("b179e0"), prestige=getObjectFromGUID("844d3d"), btnHandler=getObjectFromGUID("ef0906"), tbl=getObjectFromGUID("efae07")},

		{color="Red", zone=getObjectFromGUID("8b37f7"), value=0, count=0,
        container=getObjectFromGUID("82aca4"), prestige=getObjectFromGUID("d8cd49"), btnHandler=getObjectFromGUID("9fd676"), tbl=getObjectFromGUID("b54e19")},

		{color="Brown", zone=getObjectFromGUID("1c13af"), value=0, count=0,
        container=getObjectFromGUID("cee112"), prestige=getObjectFromGUID("6c29ce"), btnHandler=getObjectFromGUID("5b2fc0"), tbl=getObjectFromGUID("688678")},

		{color="White", zone=getObjectFromGUID("a751f4"), value=0, count=0,
        container=getObjectFromGUID("8144bb"), prestige=getObjectFromGUID("88482c"), btnHandler=getObjectFromGUID("0a3126"), tbl=getObjectFromGUID("33b903")},
		
		-- Split zones - Code cycles through this table backwards, so zone 1 is last
		{color="Split6", zone=getObjectFromGUID("43d808"), value=0, count=0,
        container=getObjectFromGUID("b5effd"), prestige=getObjectFromGUID("43d808"), btnHandler=getObjectFromGUID("1f100d"), tbl=getObjectFromGUID("43d808")},

		{color="Split5", zone=getObjectFromGUID("39f2dd"), value=0, count=0,
        container=getObjectFromGUID("0232e3"), prestige=getObjectFromGUID("39f2dd"), btnHandler=getObjectFromGUID("9a5313"), tbl=getObjectFromGUID("39f2dd")},

		{color="Split4", zone=getObjectFromGUID("df3fa1"), value=0, count=0,
        container=getObjectFromGUID("1c1194"), prestige=getObjectFromGUID("df3fa1"), btnHandler=getObjectFromGUID("0f078a"), tbl=getObjectFromGUID("df3fa1")},

		{color="Split3", zone=getObjectFromGUID("391dea"), value=0, count=0,
        container=getObjectFromGUID("5f8f1e"), prestige=getObjectFromGUID("391dea"), btnHandler=getObjectFromGUID("a356c5"), tbl=getObjectFromGUID("391dea")},

		{color="Split2", zone=getObjectFromGUID("e527cb"), value=0, count=0,
        container=getObjectFromGUID("3e331e"), prestige=getObjectFromGUID("e527cb"), btnHandler=getObjectFromGUID("c84a39"), tbl=getObjectFromGUID("e527cb")},
        
		{color="Split1", zone=getObjectFromGUID("f673d7"), value=0, count=0,
        container=getObjectFromGUID("b2bf24"), prestige=getObjectFromGUID("f673d7"), btnHandler=getObjectFromGUID("35ea56"), tbl=getObjectFromGUID("f673d7")},
	}
	...
	if roundTimer then
		roundTimer.setValue(GetSetting("Rounds.LoadTime", 60))
...
function timerStart()
	...
	if bonusTimer.getValue() < 1 then
		resetTimer(GetSetting("Rounds.BonusTime", 1200))
		bonusRound()
	end
